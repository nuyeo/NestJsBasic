...
describe('BoardController', () => {
  ...
  //   it('', async () => {
  //     const beforeResponse = await controller.getAllBoard();
  //     const beforeLength = beforeResponse.length;

  //     /**
  //      * 단, 타이틀은 무조건 필요하고
  //      * 설명은 없어도 됩니다.
  //      */
  //     const createdBoard = await controller.createBoard({
  //       title: 'title',
  //       description: 'description',
  //     });

  //     const afterResponse = await controller.getAllBoard();
  //     const afterLength = afterResponse.length;

  //     expect(createdBoard.title).toBe('title');
